...
namespace DTcms.DAL
{
    ...
    public partial class user_oauth
    {
        ...
        public int Add(Model.user_oauth model)
        {
            ...
            strSql.Append("user_id,user_name,oauth_name,oauth_access_token,oauth_openid,add_time,naem,Image,gender)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@naem",SqlDbType.NVarChar,100),
                    new SqlParameter("@Image",SqlDbType.NVarChar,255),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,user_id,user_name,oauth_name,oauth_access_token,oauth_openid,add_time,naem,Image,gender");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,user_id,user_name,oauth_name,oauth_access_token,oauth_openid,add_time,naem,Image,gender ");
            strSql.Append(" FROM " + databaseprefix + "user_oauth ");
            if (strWhere.Trim() != "")
            {
        ...
        public Model.user_oauth DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["naem"] != null && row["naem"].ToString() != "")
                {
                    model.naem = row["naem"].ToString();
                }
